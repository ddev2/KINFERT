	...
	begin
		...
		repeat
			for ind := Low(BigCohortWomenThreads) to High(BigCohortWomenThreads) do begin
				if BigCohortWomenThreads[ind].AFinished and not BigCohortWomenThreads[ind].FATestedFinished then begin
					BigCohortWomenThreads[ind].FATestedFinished := true;
					Dec(nActiveThreads);
					BigCohortWomenThreads[ind].Terminate;
				end
				else if (nActiveThreads < gMaxThreads) and (not BigCohortWomenThreads[ind].FAStarted) then begin
					Inc (nActiveThreads);
